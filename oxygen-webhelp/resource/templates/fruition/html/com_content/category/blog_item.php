...
<?php if ($useDefList || ($datepos == 2 && $params->get('show_publish_date'))) : ?>
<div class="article-info clearfix">
 <ul class="article-info-list">
 
  <?php if ($datepos == 2 && $params->get('show_publish_date')) : ?>
	<li class="published">
...
?>
		<p class="readmore">
				<a class="btn btn-primary rounded" href="<?php echo $link; ?>">
					...
					elseif ($params->get('show_readmore_title', 0) == 0) :
						echo JText::sprintf('TMPL_MB2_READ_MORE');
					else :

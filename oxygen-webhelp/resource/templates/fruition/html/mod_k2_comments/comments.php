		...
		<?php foreach ($comments as $key=>$comment):	?>
            <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
                <div class="item-inner clearfix">			
    				...
    				<?php endif; ?> 
					<?php if ($params->get('commenterName') || $params->get('commentDate') || $params->get('itemTitle') || $params->get('itemCategory')): ?>
                    <div class="comment-text">                    
                        ...
                        <?php else: ?>
                            <span class="lcComment"><?php echo $comment->commentText; ?></span>
                        <?php endif; ?> 
                        <?php if ($params->get('commentDate')|| $params->get('commenterName')) : ?>
                        <div class="comment-info clearfix">                                
							<?php if ($params->get('commenterName')) : ?>
                            <span class="lcUsername"><?php echo JText::_('TMPL_MB2_K2_WRITTEN_BY'); ?>
                            ...
                            <span class="lcCommentDate">
                                ...
                                <?php else: ?>
                                <?php echo JText::_('TMPL_MB2_K2_WRITTEN_ON'); ?> <?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC3')); ?>
                                <?php endif; ?>
                            </span>
                            <?php endif; ?>
                       	</div>

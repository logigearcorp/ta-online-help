	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
		<!--<fieldset>-->
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset) : ?>
				...
				<?php endif ?>
			<?php endforeach;?>
            <p><legend><?php echo JText::_('COM_CONTACT_FORM_LABEL'); ?></legend></p>
			<div class="form-actions"><button class="btn btn-primary btn-lg validate rounded" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>

...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	<?php if ($this->params->get('show_contact_list') && count($this->contacts) > 1) : ?>
		<form action="#" method="get" name="selectForm" id="selectForm">
			<span class="select-info"><?php echo JText::_('COM_CONTACT_SELECT_CONTACT'); ?></span>
	...
	<?php if ($this->params->get('presentation_style') == 'plain'):?>
		<?php  //echo '<h3 class="contact-part-heading">'. JText::_('COM_CONTACT_DETAILS').'</h3>';  ?>
	<?php endif; ?>

	<?php if ($this->contact->image && $this->params->get('show_image')) : ?>
		<div class="thumbnail">
			<?php echo JHtml::_('image', $this->contact->image, JText::_('COM_CONTACT_IMAGE_DETAILS'), array('align' => '', 'itemprop' => 'image')); ?>
		</div>
	<?php endif; ?>
	...
	<?php if ($this->params->get('allow_vcard')) :	?>
		<div class="download-vcard"><?php echo JText::_('COM_CONTACT_DOWNLOAD_INFORMATION_AS');?>
	...
	<?php if ($this->params->get('show_email_form') && ($this->contact->email_to || $this->contact->user_id)) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php //echo '<h3 class="contact-part-heading">'. JText::_('COM_CONTACT_EMAIL_FORM').'</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->params->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="contact-part-heading">'. JText::_('JGLOBAL_ARTICLES').'</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="contact-part-heading">'. JText::_('COM_CONTACT_PROFILE').'</h3>';  ?>
		<?php endif; ?>
	...
	<?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style') == 'plain'):?>
			<?php echo '<h3 class="contact-part-heading">'. JText::_('COM_CONTACT_OTHER_INFORMATION').'</h3>';  ?>
		<?php endif; ?>

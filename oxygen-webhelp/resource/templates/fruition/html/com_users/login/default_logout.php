...
?>
<div class="logout well <?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post" class="form-horizontal">
		<div class="control-group">
			<div class="controls">
				<button type="submit" class="btn btn-primary rounded"><i class="fa fa-unlock"></i> <?php echo JText::_('JLOGOUT'); ?></button>
			</div>
		</div>

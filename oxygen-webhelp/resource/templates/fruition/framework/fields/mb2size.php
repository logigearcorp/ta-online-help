...
class JFormFieldMb2size extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<p>' . JText::_('TMPL_MB2_WIDTH') . ':<input type="text" name="' . $this->name . '[w]" id="' . $this->id . '_w" value="' . $wval . '"' . $style. ' />' . $suff . '</p>';
		$html[] = '<p>' . JText::_('TMPL_MB2_HEIGHT') . ':<input type="text" name="' . $this->name . '[h]" id="' . $this->id . '_h" value="' . $hval . '"' . $style. ' />' . $suff  . '</p>';
		$html[] = '</div>';
